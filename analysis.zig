...
const s_eng = "Defend the east wall of the castle!";
const s_eng_strip = "defendtheeastwallofthecastle";
...
test "index of coincidence" {
    ...
    // TODO decide whether to use longer text and make test more precise
